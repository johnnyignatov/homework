...
$(document).ready(function () {
    ...
    create.addEventListener('click', function (e) {
        ...
        $.get("https://api.myjson.com/bins/fa8iz", function (data, textStatus, jqXHR) {
            newUserArr = [].concat(_toConsumableArray(data));
 ...
 */
if (void 0 === jQuery) {
    var jQuery;jQuery = "function" == typeof require ? $ = require("jquery") : $;
}!function (a) {
    "function" == typeof define && define.amd ? define(["jquery"], function (b) {
        return a(b);
    }) : "object" == (typeof module === 'undefined' ? 'undefined' : _typeof(module)) && "object" == _typeof(module.exports) ? exports = a(require("jquery")) : a(jQuery);
}(function (a) {
    function b(a) {
        var b = 7.5625,
            c = 2.75;return a < 1 / c ? b * a * a : a < 2 / c ? b * (a -= 1.5 / c) * a + .75 : a < 2.5 / c ? b * (a -= 2.25 / c) * a + .9375 : b * (a -= 2.625 / c) * a + .984375;
    }a.easing.jswing = a.easing.swing;var c = Math.pow,
        d = Math.sqrt,
        e = Math.sin,
        f = Math.cos,
        g = Math.PI,
        ...
        i = 1.525 * h,
        j = 2 * g / 3,
        k = 2 * g / 4.5;a.extend(a.easing, { def: "easeOutQuad", swing: function swing(b) {
            ...
            return 1 - b(1 - a);
        }, easeOutBounce: b, easeInOutBounce: function easeInOutBounce(a) {
    ...
    function b(a) {
        ...
        var c = function c(a, b) {
            ...
            var e = 0,
                f = a.length,
                g = b(a);if (d) {
                if (g) for (; f > e && !1 !== c.apply(a[e], d); e++) {} else for (e in a) {
                    if (!1 === c.apply(a[e], d)) break;
                }
            } else if (g) for (; f > e && !1 !== c.call(a[e], e, a[e]); e++) {} else for (e in a) {
    ...
    return function (a, b, c, d) {
        function e(a) {
            ...
            var c = a;return p.isString(a) ? t.Easings[a] || (c = !1) : c = p.isArray(a) && 1 === a.length ? h.apply(null, a) : p.isArray(a) && 2 === a.length ? u.apply(null, a.concat([b])) : !(!p.isArray(a) || 4 !== a.length) && i.apply(null, a), !1 === c && (c = t.Easings[t.defaults.easing] ? t.defaults.easing : s), c;
        }function k(a) {
            if (a) {
            ...
            if (!t.State.calls[a]) return !1;for (var c = t.State.calls[a][0], e = t.State.calls[a][1], f = t.State.calls[a][2], h = t.State.calls[a][4], i = !1, j = 0, k = c.length; k > j; j++) {
                var l = c[j].element;if (b || f.loop || ("none" === f.display && v.setPropertyValue(l, "display", f.display), "hidden" === f.visibility && v.setPropertyValue(l, "visibility", f.visibility)), !0 !== f.loop && (m.queue(l)[1] === d || !/\.velocityQueueEntryFlag/i.test(m.queue(l)[1])) && g(l)) {
                ...
                }), t(l, "reverse", { loop: !0, delay: f.delay })), !1 !== f.queue && m.dequeue(l, f.queue);
            }t.State.calls[a] = !1;for (var o = 0, p = t.State.calls.length; p > o; o++) {
            ...
            function a(a) {
                ...
                var f,
                    ...
                    j = [0],
                    k = 0;for (b = parseFloat(b) || 500, d = parseFloat(d) || 20, e = e || null, i.tension = b, i.friction = d, f = null !== e, f ? (k = a(b, d), g = k / e * .016) : g = .016; h = c(h || i, g), j.push(1 + h.x), k += 16, Math.abs(h.x) > 1e-4 && Math.abs(h.v) > 1e-4;) {}return f ? function (a) {
            ...
            t.Easings[b[0]] = i.apply(null, b[1]);
                    ...
                    var d = v.Hooks.registered[a];if (d) {
                        var e,
                            f = d[0],
                            g = d[1];return c = v.Hooks.cleanRootPropertyValue(f, c), e = c.toString().match(v.RegEx.valueSplit), e[g] = b, e.join(" ");
                    }return c;
                ...
                function a(a) {
                    function l(a, b) {
                        ...
                        var r,
                            ...
                            A = parseFloat(h.offset) || 0;h.container ? p.isWrapped(h.container) || p.isNode(h.container) ? (h.container = h.container[0] || h.container, r = h.container["scroll" + z], w = r + m(f).position()[z.toLowerCase()] + A) : h.container = null : (r = t.State.scrollAnchor[t.State["scrollProperty" + z]], u = t.State.scrollAnchor[t.State["scrollProperty" + ("Left" === z ? "Top" : "Left")]], w = m(f).offset()[z.toLowerCase()] + A), i = { scroll: { rootPropertyValue: !1, startValue: r, currentValue: r, endValue: w, unitType: "", easing: h.easing, scrollData: { container: h.container, direction: z, alternateValue: u } }, element: f }, t.debug && console.log("tweensContainer (scroll): ", i.scroll, f);
                    } else if ("reverse" === C) {
                        if (!g(f).tweensContainer) return void m.dequeue(f, h.queue);"none" === g(f).opts.display && (g(f).opts.display = "auto"), "hidden" === g(f).opts.visibility && (g(f).opts.visibility = "visible"), g(f).opts.loop = !1, g(f).opts.begin = null, g(f).opts.complete = null, s.easing || delete h.easing, s.duration || delete h.duration, h = m.extend({}, g(f).opts, h);var D = m.extend(!0, {}, g(f).tweensContainer);for (var E in D) {
                            if ("element" !== E) {
                                var F = D[E].startValue;D[E].startValue = D[E].currentValue = D[E].endValue, D[E].endValue = F, p.isEmptyObject(s) || (D[E].easing = h.easing), t.debug && console.log("reverse tweensContainer (" + E + "): " + JSON.stringify(D[E]), f);
                            }
                        }i = D;
                    } else if ("start" === C) {
                        var D;g(f).tweensContainer && !0 === g(f).isAnimating && (D = g(f).tweensContainer), m.each(q, function (a, b) {
                            ...
                            var H = l(q[G]),
                                K = H[0],
                                L = H[1],
                                M = H[2];G = v.Names.camelCase(G);var N = v.Hooks.getRoot(G),
                                O = !1;if (g(f).isSVG || "tween" === N || !1 !== v.Names.prefixCheck(N)[1] || v.Normalizations.registered[N] !== d) {
                                (h.display !== d && null !== h.display && "none" !== h.display || h.visibility !== d && "hidden" !== h.visibility) && /opacity|filter/.test(G) && !M && 0 !== K && (M = 0), h._cacheValues && D && D[G] ? (M === d && (M = D[G].endValue + D[G].unitType), O = g(f).rootPropertyValueCache[N]) : v.Hooks.registered[G] ? M === d ? (O = v.getPropertyValue(f, N), M = v.getPropertyValue(f, G, O)) : O = v.Hooks.templates[N][1] : M === d && (M = v.getPropertyValue(f, G));var P,
                                    Q,
                                    R,
                                    S = !1;if (P = n(G, M), M = P[0], R = P[1], P = n(G, K), K = P[0].replace(/^([+-\/*])=/, function (a, b) {
                                    return S = b, "";
                                }), Q = P[1], M = parseFloat(M) || 0, K = parseFloat(K) || 0, "%" === Q && (/^(fontSize|lineHeight)$/.test(G) ? (K /= 100, Q = "em") : /^scale/.test(G) ? (K /= 100, Q = "") : /(Red|Green|Blue)$/i.test(G) && (K = K / 100 * 255, Q = "")), /[\/*]/.test(S)) Q = R;else if (R !== Q && 0 !== M) if (0 === K) Q = R;else {
                                    e = e || function () {
                                    ...
                                    }();var T = /margin|padding|left|right|width|text|word|letter/i.test(G) || /X$/.test(G) || "x" === G ? "x" : "y";switch (R) {case "%":
                                            M *= "x" === T ? e.percentToPxWidth : e.percentToPxHeight;break;case "px":
                                            break;default:
                                            M *= e[R + "ToPx"];}switch (Q) {case "%":
                                            M *= 1 / ("x" === T ? e.percentToPxWidth : e.percentToPxHeight);break;case "px":
                                            break;default:
                                            M *= 1 / e[Q + "ToPx"];}
                                }switch (S) {case "+":
                                        K = M + K;break;case "-":
                                        K = M - K;break;case "*":
                                        K *= M;break;case "/":
                                        K = M / K;}i[G] = { rootPropertyValue: O, startValue: M, currentValue: M, endValue: K, unitType: Q, easing: L }, t.debug && console.log("tweensContainer (" + G + "): " + JSON.stringify(i[G]), f);
                    ...
                    i = {};switch (g(f) === d && t.init(f), parseFloat(h.delay) && !1 !== h.queue && m.queue(f, h.queue, function (a) {
                    ...
                    B.resolver = a, B.rejecter = b;
                        ...
                        m.each(o, function (a, b) {
                            ...
                            b && m.each(b[1], function (c, e) {
                                var f = s === d ? "" : s;return !0 !== f && b[2].queue !== f && (s !== d || !1 !== b[2].queue) || void m.each(o, function (c, d) {
                        ...
                        if (!m.isPlainObject(q) || p.isEmptyObject(q)) {
                            if (p.isString(q) && t.Redirects[q]) {
                                var E = m.extend({}, s),
                                    F = E.duration,
                                    G = E.delay || 0;return !0 === E.backwards && (o = m.extend(!0, [], o).reverse()), m.each(o, function (a, b) {
    ...
    function e(a, b, c) {
        ...
        for (var c, e, f = b[0].toUpperCase() + b.slice(1), g = 0; g < ia.length;) {
            if (c = ia[g], (e = c ? c + f : b) in a) return e;g++;
        }return d;
    }function w() {
        return oa++;
    }function x(a) {
        ...
        var b = a.options.inputClass;return new (b || (ra ? N : sa ? Q : qa ? S : M))(a, A);
    }function A(a, b, c) {
        var d = c.pointers.length,
            e = c.changedPointers.length,
            f = b & wa && 0 == d - e,
            g = b & (ya | za) && 0 == d - e;c.isFirst = !!f, c.isFinal = !!g, f && (a.session = {}), c.eventType = b, B(a, c), a.emit("hammer.input", c), a.recognize(c), a.session.prevInput = c;
    }function B(a, b) {
        var c = a.session,
            d = b.pointers,
        ...
        var c = b.center,
            d = a.offsetDelta || {},
            e = a.prevDelta || {},
            f = a.prevInput || {};(b.eventType === wa || f.eventType === ya) && (e = a.prevDelta = { x: f.deltaX || 0, y: f.deltaY || 0 }, d = a.offsetDelta = { x: c.x, y: c.y }), b.deltaX = e.x + (c.x - d.x), b.deltaY = e.y + (c.y - d.y);
    }function D(a, b) {
        var c,
            e,
            f,
            g,
            h = a.lastInterval || b,
            i = b.timeStamp - h.timeStamp;if (b.eventType != za && (i > va || h.velocity === d)) {
        ...
        var c = t(a.touches),
            d = t(a.changedTouches);return b & (ya | za) && (c = u(c.concat(d), "identifier", !0)), [c, d];
    }function Q() {
        this.evTarget = Va, this.targetIds = {}, y.apply(this, arguments);
    }function R(a, b) {
        var c = t(a.touches),
            d = this.targetIds;if (b & (wa | xa) && 1 === c.length) return d[c[0].identifier] = !0, [c, c];var e,
            f,
            g = t(a.changedTouches),
            h = [],
            i = this.target;if (f = c.filter(function (a) {
            return p(a.target, i);
        }), b === wa) for (e = 0; e < f.length;) {
            d[f[e].identifier] = !0, e++;
        }for (e = 0; e < g.length;) {
            d[g[e].identifier] && h.push(g[e]), b & (ya | za) && delete d[g[e].identifier], e++;
        ...
        if (q(a, _a)) return _a;var b = q(a, ab),
            c = q(a, bb);return b && c ? ab + " " + bb : b || c ? b ? ab : bb : q(a, $a) ? $a : Za;
    }function V(a) {
        ...
        Ha = Fa | Ga,
        Ia = ["x", "y"],
        Ja = ["clientX", "clientY"];y.prototype = { handler: function handler() {}, init: function init() {
            this.evEl && n(this.element, this.evEl, this.domHandler), this.evTarget && n(this.target, this.evTarget, this.domHandler), this.evWin && n(x(this.element), this.evWin, this.domHandler);
        }, destroy: function destroy() {
            this.evEl && o(this.element, this.evEl, this.domHandler), this.evTarget && o(this.target, this.evTarget, this.domHandler), this.evWin && o(x(this.element), this.evWin, this.domHandler);
        } };var Ka = { mousedown: wa, mousemove: xa, mouseup: ya },
        La = "mousedown",
        Ma = "mousemove mouseup";j(M, y, { handler: function handler(a) {
            var b = Ka[a.type];b & wa && 0 === a.button && (this.pressed = !0), b & xa && 1 !== a.which && (b = ya), this.pressed && this.allow && (b & ya && (this.pressed = !1), this.callback(this.manager, b, { pointers: [a], changedPointers: [a], pointerType: ua, srcEvent: a }));
        } });var Na = { pointerdown: wa, pointermove: xa, pointerup: ya, pointercancel: za, pointerout: za },
        Oa = { 2: ta, 3: "pen", 4: ua, 5: "kinect" },
        Pa = "pointerdown",
        Qa = "pointermove pointerup pointercancel";a.MSPointerEvent && (Pa = "MSPointerDown", Qa = "MSPointerMove MSPointerUp MSPointerCancel"), j(N, y, { handler: function handler(a) {
            var b = this.store,
                c = !1,
                ...
                g = f == ta,
                h = s(b, a.pointerId, "pointerId");e & wa && (0 === a.button || g) ? 0 > h && (b.push(a), h = b.length - 1) : e & (ya | za) && (c = !0), 0 > h || (b[h] = a, this.callback(this.manager, e, { pointers: b, changedPointers: [a], pointerType: f, srcEvent: a }), c && b.splice(h, 1));
        } });var Ra = { touchstart: wa, touchmove: xa, touchend: ya, touchcancel: za },
        Sa = "touchstart",
        Ta = "touchstart touchmove touchend touchcancel";j(O, y, { handler: function handler(a) {
            var b = Ra[a.type];if (b === wa && (this.started = !0), this.started) {
                var c = P.call(this, a, b);b & (ya | za) && 0 == c[0].length - c[1].length && (this.started = !1), this.callback(this.manager, b, { pointers: c[0], changedPointers: c[1], pointerType: ta, srcEvent: a });
            }
        } });var Ua = { touchstart: wa, touchmove: xa, touchend: ya, touchcancel: za },
        Va = "touchstart touchmove touchend touchcancel";j(Q, y, { handler: function handler(a) {
            var b = Ua[a.type],
            ...
            var d = c.pointerType == ta,
                e = c.pointerType == ua;if (d) this.mouse.allow = !1;else if (e && !this.mouse.allow) return;b & (ya | za) && (this.mouse.allow = !0), this.callback(a, b, c);
        }, destroy: function destroy() {
        ...
        _a = "none",
        ab = "pan-x",
        bb = "pan-y";T.prototype = { set: function set(a) {
            ...
            if (!Xa) {
                var b = a.srcEvent,
                    ...
                    e = q(d, _a),
                    f = q(d, bb),
                    g = q(d, ab);return e || f && c & Fa || g && c & Ga ? this.preventSrc(b) : void 0;
            }
        ...
        fb = 8,
        gb = fb,
        hb = 16;V.prototype = { defaults: {}, set: function set(a) {
            ...
            function b(b) {
                ...
                d = this.state;fb > d && b(!0), b(), d >= fb && b(!0);
        }, tryEmit: function tryEmit(a) {
            return this.canEmit() ? this.emit(a) : void (this.state = 32);
        }, canEmit: function canEmit() {
            for (var a = 0; a < this.requireFail.length;) {
                if (!(this.requireFail[a].state & (32 | cb))) return !1;a++;
            }return !0;
        }, recognize: function recognize(a) {
            var b = h({}, a);return l(this.options.enable, [this, b]) ? (this.state & (gb | hb | 32) && (this.state = cb), this.state = this.process(b), void (this.state & (db | eb | fb | hb) && this.tryEmit(b))) : (this.reset(), void (this.state = 32));
            ...
            var b = this.state,
                c = a.eventType,
                d = b & (db | eb),
                e = this.attrTest(a);return d && (c & za || !e) ? b | hb : d || e ? c & ya ? b | fb : b & db ? b | eb : db : 32;
        } }), j($, Z, { defaults: { event: "pan", threshold: 10, pointers: 1, direction: Ha }, getTouchAction: function getTouchAction() {
            var a = this.options.direction,
                b = [];return a & Fa && b.push(bb), a & Ga && b.push(ab), b;
            ...
            var b = this.options,
                ...
                e = a.direction,
                f = a.deltaX,
                g = a.deltaY;return e & b.direction || (b.direction & Fa ? (e = 0 === f ? Aa : 0 > f ? Ba : Ca, c = f != this.pX, d = Math.abs(a.deltaX)) : (e = 0 === g ? Aa : 0 > g ? Da : Ea, c = g != this.pY, d = Math.abs(a.deltaY))), a.direction = e, c && d > b.threshold && e & b.direction;
            ...
            var b = this.options,
                ...
                f = a.deltaTime > b.time;if (this._input = a, !d || !c || a.eventType & (ya | za) && !f) this.reset();else if (a.eventType & wa) this.reset(), this._timer = e(function () {
                this.state = gb, this.tryEmit();
            }, b.time, this);else if (a.eventType & ya) return gb;return 32;
        ...
        } }), j(ca, Z, { defaults: { event: "swipe", threshold: 10, velocity: .65, direction: Fa | Ga, pointers: 1 }, getTouchAction: function getTouchAction() {
            return $.prototype.getTouchAction.call(this);
        }, attrTest: function attrTest(a) {
            var b,
                c = this.options.direction;return c & (Fa | Ga) ? b = a.velocity : c & Fa ? b = a.velocityX : c & Ga && (b = a.velocityY), this._super.attrTest.call(this, a) && c & a.direction && a.distance > this.options.threshold && ma(b) > this.options.velocity && a.eventType & ya;
        }, emit: function emit(a) {
            ...
            var b = this.options,
                c = a.pointers.length === b.pointers,
                d = a.distance < b.threshold,
                f = a.deltaTime < b.time;if (this.reset(), a.eventType & wa && 0 === this.count) return this.failTimeout();if (d && f && c) {
                if (a.eventType != ya) return this.failTimeout();var g = !this.pTime || a.timeStamp - this.pTime < b.interval,
                    h = !this.pCenter || I(this.pCenter, a.center) < b.posThreshold;this.pTime = a.timeStamp, this.pCenter = a.center, h && g ? this.count += 1 : this.count = 1, this._input = a;if (0 === this.count % b.taps) return this.hasRequireFailures() ? (this._timer = e(function () {
                    this.state = gb, this.tryEmit();
        ...
        } }), ea.VERSION = "2.0.4", ea.defaults = { domEvents: !1, touchAction: Ya, enable: !0, inputTarget: null, inputClass: null, preset: [[ba, { enable: !1 }], [_, { enable: !1 }, ["rotate"]], [ca, { direction: Fa }], [$, { direction: Fa }, ["swipe"]], [da], [da, { event: "doubletap", taps: 2 }, ["tap"]], [aa]], cssProps: { userSelect: "default", touchSelect: "none", touchCallout: "none", contentZooming: "none", userDrag: "none", tapHighlightColor: "rgba(0,0,0,0)" } };fa.prototype = { set: function set(a) {
            ...
            var b = this.session;if (!b.stopped) {
                this.touchAction.preventDefaults(a);var c,
                    d = this.recognizers,
                    e = b.curRecognizer;(!e || e && e.state & gb) && (e = b.curRecognizer = null);for (var f = 0; f < d.length;) {
                    c = d[f], 2 === b.stopped || e && c != e && !c.canRecognizeWith(e) ? c.reset() : c.recognize(a), !e && c.state & (db | eb | fb) && (e = b.curRecognizer = c), f++;
                }
            }
        }, get: function get(a) {
    ...
    var d,
        ...
        var j = getTime();h || !1 !== c.leading || (h = j);var k = b - (j - h);return d = this, e = arguments, k <= 0 ? (clearTimeout(g), g = null, h = j, f = a.apply(d, e), d = e = null) : g || !1 === c.trailing || (g = setTimeout(i, k)), f;
    };
    ...
    a.fn.scrollTo = function (b) {
        ...
        var c = { inDuration: 300, outDuration: 225, constrainWidth: !0, hover: !1, gutter: 0, belowOrigin: !1, alignment: "left", stopPropagation: !1 };return "open" === b ? (this.each(function () {
            ...
            function d() {
                ...
                "focus" === b && (i = !0), d(), j.addClass("active"), g.addClass("active"), !0 === h.constrainWidth ? j.css("width", g.outerWidth()) : j.css("white-space", "nowrap");var c = window.innerHeight,
                    e = g.innerHeight(),
                    k = g.offset().left,
                    ...
                    n = 0,
                    o = 0,
                    p = 0;!0 === h.belowOrigin && (p = e);var q = 0,
                    r = 0,
                    ...
                    j.stop(!0, !0).css({ opacity: 0, left: 0 });var u = g.position().left + g.outerWidth() - j.outerWidth();n = -h.gutter, o = u + n;
                }j.css({ position: "absolute", top: g.position().top + p + q, left: o + r }), j.slideDown({ queue: !1, duration: h.inDuration, easing: "easeOutCubic", complete: function complete() {
                        a(this).css("height", "");
                ...
                var k = !1;g.off("click." + g.attr("id")), g.on("mouseenter", function (a) {
                    !1 === k && (e(), k = !0);
                ...
                var e = a(this),
                    ...
                    var h = a("body"),
                        ...
                        var j = d(),
                            ...
                            l = ++b;k.attr("id", j).css("z-index", 1e3 + 2 * l), e.data("overlay-id", j).css("z-index", 1e3 + 2 * l + 1), e.addClass("open"), a("body").append(k), c.dismissible && (k.click(function () {
                            g();
                        }), a(document).on("keyup.modal" + j, function (a) {
                            27 === a.keyCode && g();
                        })), e.find(".modal-close").on("click.close", function (a) {
                            g();
                        }), k.css({ display: "block", opacity: 0 }), e.css({ display: "block", opacity: 0 }), k.velocity({ opacity: c.opacity }, { duration: c.inDuration, queue: !1, ease: "easeOutCubic" }), e.data("associated-overlay", k[0]);var m = { duration: c.inDuration, queue: !1, ease: "easeOutCubic", complete: function complete() {
                                "function" == typeof c.ready && c.ready.call(this, e, f);
                            } };e.hasClass("bottom-sheet") ? e.velocity({ bottom: "0", opacity: 1 }, m) : (a.Velocity.hook(e, "scaleX", .7), e.css({ top: c.startingTop }), e.velocity({ top: c.endingTop, opacity: 1, scaleX: "1" }, m));
                    }
    ...
    a.fn.materialbox = function () {
        return this.each(function () {
            function b() {
                f = !1;var b = h.parent(".material-placeholder"),
                    d = (window.innerWidth, window.innerHeight, h.data("width")),
                    i = h.data("height");h.velocity("stop", !0), a("#materialbox-overlay").velocity("stop", !0), a(".materialbox-caption").velocity("stop", !0), a(window).off("scroll.materialbox"), a(document).off("keyup.materialbox"), a(window).off("resize.materialbox"), a("#materialbox-overlay").velocity({ opacity: 0 }, { duration: g, queue: !1, easing: "easeOutQuad", complete: function complete() {
                        e = !1, a(this).remove();
                    } }), h.velocity({ width: d, height: i, left: 0, top: 0 }, { duration: g, queue: !1, easing: "easeOutQuad", complete: function complete() {
                        b.css({ height: "", width: "", position: "", top: "", left: "" }), h.removeAttr("style"), h.attr("style", j), h.removeClass("active"), f = !0, c && c.css("overflow", "");
                    } }), a(".materialbox-caption").velocity({ opacity: 0 }, { duration: g, queue: !1, easing: "easeOutQuad", complete: function complete() {
                        a(this).remove();
                    } });
                ...
                a(this).addClass("initialized");var c,
                    ...
                    j = h.attr("style");h.wrap(i), h.on("click", function () {
                    var g = h.parent(".material-placeholder"),
                        i = window.innerWidth,
                        j = window.innerHeight,
                        k = h.width(),
                        l = h.height();if (!1 === f) return b(), !1;if (e && !0 === f) return b(), !1;f = !1, h.addClass("active"), e = !0, g.css({ width: g[0].getBoundingClientRect().width, height: g[0].getBoundingClientRect().height, position: "relative", top: 0, left: 0 }), c = void 0, d = g[0].parentNode;for (; null !== d && !a(d).is(document);) {
                        var m = a(d);"visible" !== m.css("overflow") && (m.css("overflow", "visible"), c = void 0 === c ? m : c.add(m)), d = d.parentNode;
                    }h.css({ position: "absolute", "z-index": 1e3, "will-change": "left, top, width, height" }).data("width", k).data("height", l);var n = a('<div id="materialbox-overlay"></div>').css({ opacity: 0 }).click(function () {
                        !0 === f && b();
                    });h.before(n);var o = n[0].getBoundingClientRect();if (n.css({ width: i, height: j, left: -1 * o.left, top: -1 * o.top }), n.velocity({ opacity: 1 }, { duration: 275, queue: !1, easing: "easeOutQuad" }), "" !== h.data("caption")) {
                        var p = a('<div class="materialbox-caption"></div>');p.text(h.data("caption")), a("body").append(p), p.css({ display: "inline" }), p.velocity({ opacity: 1 }, { duration: 275, queue: !1, easing: "easeOutQuad" });
                    }var q = 0,
                        r = k / i,
                        s = l / j,
                        t = 0,
                        u = 0;r > s ? (q = l / k, t = .9 * i, u = .9 * i * q) : (q = k / l, t = .9 * j * q, u = .9 * j), h.hasClass("responsive-img") ? h.velocity({ "max-width": t, width: k }, { duration: 0, queue: !1, complete: function complete() {
                            h.css({ left: 0, top: 0 }).velocity({ height: u, width: t, left: a(document).scrollLeft() + i / 2 - h.parent(".material-placeholder").offset().left - t / 2, top: a(document).scrollTop() + j / 2 - h.parent(".material-placeholder").offset().top - u / 2 }, { duration: 275, queue: !1, easing: "easeOutQuad", complete: function complete() {
                                    f = !0;
                                } });
                        } }) : h.css("left", 0).css("top", 0).velocity({ height: u, width: t, left: a(document).scrollLeft() + i / 2 - h.parent(".material-placeholder").offset().left - t / 2, top: a(document).scrollTop() + j / 2 - h.parent(".material-placeholder").offset().top - u / 2 }, { duration: 275, queue: !1, easing: "easeOutQuad", complete: function complete() {
                            f = !0;
    ...
    var b = { init: function init(b) {
            var c = { onShow: null, swipeable: !1, responsiveThreshold: 1 / 0 };b = a.extend(c, b);var d = Materialize.objectSelectorString(a(this));return this.each(function (c) {
                var e,
                    ...
                    u = function u(a) {
                    q - a >= 0 ? (h.velocity({ right: s(e) }, { duration: 300, queue: !1, easing: "easeOutQuad" }), h.velocity({ left: t(e) }, { duration: 300, queue: !1, easing: "easeOutQuad", delay: 90 })) : (h.velocity({ left: t(e) }, { duration: 300, queue: !1, easing: "easeOutQuad" }), h.velocity({ right: s(e) }, { duration: 300, queue: !1, easing: "easeOutQuad", delay: 90 }));
                    ...
                    h.css({ right: s(e) }), h.css({ left: t(e) });
                }, 0), a(window).off("resize.tabs-" + j).on("resize.tabs-" + j, function () {
                    n = k.width(), p = Math.max(n, k[0].scrollWidth) / m.length, q < 0 && (q = 0), 0 !== p && 0 !== n && (h.css({ right: s(e) }), h.css({ left: t(e) }));
                    ...
                    var b = a(Materialize.escapeHash(this.hash));b.addClass("carousel-item"), o = o.add(b);
                        ...
                        if (!r) {
                            var c = q;q = g.index(a), e = m.eq(q), u(c), "function" == typeof b.onShow && b.onShow.call(k[0], f);
                        }
                    ...
                    if (a(this).parent().hasClass("disabled")) return void c.preventDefault();if (!a(this).attr("target")) {
                        r = !0, n = k.width(), p = Math.max(n, k[0].scrollWidth) / m.length, e.removeClass("active");var d = f;e = a(this), f = a(Materialize.escapeHash(this.hash)), m = k.find("li.tab a");e.position();e.addClass("active"), prev_index = q, q = m.index(a(this)), q < 0 && (q = 0), b.swipeable ? o.length && o.carousel("set", q, function () {
    ...
    a.fn.tooltip = function (c) {
        var d = { delay: 350, tooltip: "", position: "bottom", html: !1 };return "remove" === c ? (this.each(function () {
            ...
            var d = Materialize.guid(),
                e = a(this);e.attr("data-tooltip-id") && a("#" + e.attr("data-tooltip-id")).remove(), e.attr("data-tooltip-id", d);var f,
                g,
                h,
                i,
                j,
                k,
                l = function l() {
                f = e.attr("data-html") ? "true" === e.attr("data-html") : c.html, g = e.attr("data-delay"), g = void 0 === g || "" === g ? c.delay : g, h = e.attr("data-position"), h = void 0 === h || "" === h ? c.position : h, i = e.attr("data-tooltip"), i = void 0 === i || "" === i ? c.tooltip : i;
            };l();j = function () {
                var b = a('<div class="material-tooltip"></div>');return i = f ? a("<span></span>").html(i) : a("<span></span>").text(i), b.append(i).appendTo(a("body")).attr("id", d), k = a('<div class="backdrop"></div>'), k.appendTo(b), b;
            }(), e.off("mouseenter.tooltip mouseleave.tooltip");var m,
                n = !1;e.on({ "mouseenter.tooltip": function mouseenterTooltip(a) {
                    var c = function c() {
                        l(), n = !0, j.velocity("stop"), k.velocity("stop"), j.css({ visibility: "visible", left: "0px", top: "0px" });var a,
                            c,
                            d,
                            f = e.outerWidth(),
                            g = e.outerHeight(),
    ...
    function b(a) {
        ...
        var b,
            d,
            e = { top: 0, left: 0 },
            f = a && a.ownerDocument;return b = f.documentElement, void 0 !== a.getBoundingClientRect && (e = a.getBoundingClientRect()), d = c(f), { top: e.top + d.pageYOffset - b.clientTop, left: e.left + d.pageXOffset - b.clientLeft };
    }function e(a) {
        var b = "";for (var c in a) {
            a.hasOwnProperty(c) && (b += c + ":" + a[c] + ";");
        }return b;
    }function f(a) {
        if (!1 === k.allowEvent(a)) return null;for (var b = null, c = a.target || a.srcElement; null !== c.parentElement;) {
    ...
    c = c || "";var e = document.getElementById("toast-container");null === e && (e = document.createElement("div"), e.id = "toast-container", document.body.appendChild(e));var f = function (a) {
        var b = document.createElement("div");if (b.classList.add("toast"), c) for (var e = c.split(" "), f = 0, g = e.length; f < g; f++) {
            ...
            var c = a.deltaX;b.classList.contains("panning") || b.classList.add("panning");var d = 1 - Math.abs(c / 80);d < 0 && (d = 0), Vel(b, { left: c, opacity: d }, { duration: 50, queue: !1, easing: "easeOutQuad" });
        }), h.on("panend", function (a) {
            var c = a.deltaX;Math.abs(c) > 80 ? Vel(b, { marginTop: "-40px" }, { duration: 375, easing: "easeOutExpo", queue: !1, complete: function complete() {
                    "function" == typeof d && d(), b.parentNode.removeChild(b);
                } }) : (b.classList.remove("panning"), Vel(b, { left: 0, opacity: 1 }, { duration: 300, easing: "easeOutExpo", queue: !1 }));
        }), b;
    }(a);a && e.appendChild(f), f.style.opacity = 0, Vel(f, { translateY: "-35px", opacity: 1 }, { duration: 300, easing: "easeOutCubic", queue: !1 });var g,
        h = b;null != h && (g = setInterval(function () {
        null === f.parentNode && window.clearInterval(g), f.classList.contains("panning") || (h -= 20), h <= 0 && (Vel(f, { opacity: 0, marginTop: "-40px" }, { duration: 375, easing: "easeOutExpo", queue: !1, complete: function complete() {
                "function" == typeof d && d(), this[0].parentNode.removeChild(this[0]);
            } }), window.clearInterval(g));
    }, 20));
}, function (a) {
    var b = { init: function init(b) {
            var c = { menuWidth: 300, edge: "left", closeOnClick: !1, draggable: !0, onOpen: null, onClose: null };b = a.extend(c, b), a(this).each(function () {
                var c = a(this),
                ...
                }), !0 === b.closeOnClick && e.on("click.itemclick", "a:not(.collapsible-header)", function () {
                    ...
                    i && g();
                }), f.hammer({ prevent_default: !1 }).on("pan", function (c) {
                    if ("touch" == c.gesture.pointerType) {
                        var d = (c.gesture.direction, c.gesture.center.x),
                            f = c.gesture.center.y;c.gesture.velocityX;if (0 === d && 0 === f) return;var h = a("body"),
                            j = a("#sidenav-overlay"),
                            k = h.innerWidth();if (h.css("overflow", "hidden"), h.width(k), 0 === j.length && (j = a('<div id="sidenav-overlay"></div>'), j.css("opacity", 0).click(function () {
                            g();
                        }), "function" == typeof b.onOpen && b.onOpen.call(this, e), a("body").append(j)), "left" === b.edge && (d > b.menuWidth ? d = b.menuWidth : d < 0 && (d = 0)), "left" === b.edge) d < b.menuWidth / 2 ? i = !1 : d >= b.menuWidth / 2 && (i = !0), e.css("transform", "translateX(" + (d - b.menuWidth) + "px)");else {
                            d < window.innerWidth - b.menuWidth / 2 ? i = !0 : d >= window.innerWidth - b.menuWidth / 2 && (i = !1);var l = d - b.menuWidth / 2;l < 0 && (l = 0), e.css("transform", "translateX(" + l + "px)");
                        }var m;"left" === b.edge ? (m = d / b.menuWidth, j.velocity({ opacity: m }, { duration: 10, queue: !1, easing: "easeOutQuad" })) : (m = Math.abs((d - window.innerWidth) / b.menuWidth), j.velocity({ opacity: m }, { duration: 10, queue: !1, easing: "easeOutQuad" }));
                    }
    ...
    function b(b, c, d, e) {
        var g = a();return a.each(f, function (a, f) {
            if (f.height() > 0) {
                var h = f.offset().top,
                    i = f.offset().left,
                    j = i + f.width(),
                    k = h + f.height();!(i > c || j < e || h > d || k < b) && g.push(f);
            }
        }), g;
    }function c(c) {
        ++i;var d = e.scrollTop(),
        ...
        var g = { throttle: 100, scrollOffset: 200, activeClass: "active", getActiveElement: function getActiveElement(a) {
                return 'a[href="#' + a + '"]';
            } };d = a.extend(g, d);var i = [];b = a(b), b.each(function (b, c) {
            ...
            i = a.grep(i, function (a) {
                return 0 != a.height();
            });var b = a(this);i[0] ? (a(d.getActiveElement(i[0].attr("id"))).removeClass(d.activeClass), b.data("scrollSpy:id") < i[0].data("scrollSpy:id") ? i.unshift(a(this)) : i.push(a(this))) : i.push(a(this)), a(d.getActiveElement(i[0].attr("id"))).addClass(d.activeClass);
        }), b.on("scrollSpy:exit", function () {
            if (i = a.grep(i, function (a) {
                return 0 != a.height();
            }), i[0]) {
                a(d.getActiveElement(i[0].attr("id"))).removeClass(d.activeClass);var b = a(this);i = a.grep(i, function (a) {
    ...
    a(document).ready(function () {
        function b(b) {
            var c = b.css("font-family"),
                e = b.css("font-size"),
                f = b.css("line-height");e && d.css("font-size", e), c && d.css("font-family", c), f && d.css("line-height", f), b.data("original-height") || b.data("original-height", b.height()), "off" === b.attr("wrap") && d.css("overflow-wrap", "normal").css("white-space", "pre"), d.text(b.val() + "\n");var g = d.html().replace(/\n/g, "<br>");d.html(g), b.is(":visible") ? d.css("width", b.width()) : d.css("width", a(window).width() / 2), b.data("original-height") <= d.height() ? b.css("height", d.height()) : b.val().length < b.data("previous-length") && b.css("height", b.data("original-height")), b.data("previous-length", b.val().length);
            ...
            a("input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea").each(function (b, c) {
                var d = a(this);a(c).val().length > 0 || a(c).is(":focus") || c.autofocus || void 0 !== d.attr("placeholder") ? d.siblings("label").addClass("active") : a(c)[0].validity ? d.siblings("label").toggleClass("active", !0 === a(c)[0].validity.badInput) : d.siblings("label").removeClass("active");
            });
            ...
            var b = a(this),
                c = ".prefix";0 === b.val().length && !0 !== b[0].validity.badInput && void 0 === b.attr("placeholder") && (c += ", label"), b.siblings(c).removeClass("active"), validate_field(b);
        }), window.validate_field = function (a) {
            var b = void 0 !== a.attr("data-length"),
                c = parseInt(a.attr("data-length")),
                d = a.val().length;0 === a.val().length && !1 === a[0].validity.badInput ? a.hasClass("validate") && (a.removeClass("valid"), a.removeClass("invalid")) : a.hasClass("validate") && (a.is(":valid") && b && d <= c || a.is(":valid") && !b ? (a.removeClass("invalid"), a.addClass("valid")) : (a.removeClass("valid"), a.addClass("invalid")));
        };a(document).on("keyup.radio", "input[type=radio], input[type=checkbox]", function (b) {
            if (9 === b.which) {
                a(this).addClass("tabbed");return void a(this).one("blur", function (b) {
                    a(this).removeClass("tabbed");
                });
            }
        });var d = a(".hiddendiv").first();d.length || (d = a('<div class="hiddendiv common"></div>'), a("body").append(d));a(".materialize-textarea").each(function () {
            ...
            var b = a.width() - 15,
                ...
                d = parseFloat(a.attr("min"));return (parseFloat(a.val()) - d) / (c - d) * b;
        };a(document).on("change", e, function (b) {
            var c = a(this).siblings(".thumb");c.find(".value").html(a(this).val()), c.hasClass("active") || g(c);var d = h(a(this));c.addClass("active").css("left", d);
        }), a(document).on("mousedown touchstart", e, function (b) {
            var c = a(this).siblings(".thumb");if (c.length <= 0 && (c = a('<span class="thumb"><span class="value"></span></span>'), a(this).after(c)), c.find(".value").html(a(this).val()), f = !0, a(this).addClass("active"), c.hasClass("active") || g(c), "input" !== b.type) {
                var d = h(a(this));c.addClass("active").css("left", d);
            }
            ...
            var c = a(this).children(".thumb"),
                d = a(this).find(e);if (f) {
                c.hasClass("active") || g(c);var i = h(d);c.addClass("active").css("left", i), c.find(".value").html(c.siblings(e).val());
            }
                ...
                var c,
                    ...
                    var i,
                        ...
                        var b,
                            ...
                            e = j.children(".active").first();if (13 === c && g >= 0) return b = j.children("li").eq(g), void (b.length && (b.trigger("mousedown.autocomplete"), a.preventDefault()));38 !== c && 40 !== c || (a.preventDefault(), 38 === c && g > 0 && g--, 40 === c && g < d - 1 && g++, e.removeClass("active"), g >= 0 && j.children("li").eq(g).addClass("active"));
        ...
        function c(a, b, c) {
            var e = a.indexOf(b),
                f = -1 === e;return f ? a.push(b) : a.splice(e, 1), c.siblings("ul.dropdown-content").find("li:not(.optgroup)").eq(b).toggleClass("active"), c.find("option").eq(b).prop("selected", f), d(a, c), f;
        }function d(a, b) {
            ...
            var d = a(this);if (!d.hasClass("browser-default")) {
                var e = !!d.attr("multiple"),
                    ...
                    if (a(this).is("option")) e ? n(0, a(this), "multiple") : n(0, a(this));else if (a(this).is("optgroup")) {
                    ...
                    if (9 == b.which) return void q.trigger("close");if (40 == b.which && !i.is(":visible")) return void q.trigger("open");if (13 != b.which || i.is(":visible")) {
                        b.preventDefault();var c = String.fromCharCode(b.which).toLowerCase(),
                            d = [9, 13, 27, 38, 40];if (c && -1 === d.indexOf(b.which)) {
    ...
    var b = { init: function init(b) {
            var c = { indicators: !0, height: 400, transition: 500, interval: 6e3 };return b = a.extend(c, b), this.each(function () {
                function c(a, b) {
                    ...
                    a >= j.length ? a = 0 : a < 0 && (a = j.length - 1), (k = i.find(".active").index()) != a && (e = j.eq(k), $caption = e.find(".caption"), e.removeClass("active"), e.velocity({ opacity: 0 }, { duration: b.transition, queue: !1, easing: "easeOutQuad", complete: function complete() {
                    ...
                    m = !1,
                    n = !1;h.hammer({ prevent_default: !1 }).on("pan", function (a) {
    ...
    a(document).ready(function () {
        a(document).on("click.card", ".card", function (b) {
            if (a(this).find("> .card-reveal").length) {
                var c = a(b.target).closest(".card");void 0 === c.data("initialOverflow") && c.data("initialOverflow", void 0 === c.css("overflow") ? "" : c.css("overflow")), a(b.target).is(a(".card-reveal .card-title")) || a(b.target).is(a(".card-reveal .card-title i")) ? a(this).find(".card-reveal").velocity({ translateY: 0 }, { duration: 225, queue: !1, easing: "easeInOutQuad", complete: function complete() {
                        a(this).css({ display: "none" }), c.css("overflow", c.data("initialOverflow"));
                    } }) : (a(b.target).is(a(".card .activator")) || a(b.target).is(a(".card .activator i"))) && (c.css("overflow", "hidden"), a(this).find(".card-reveal").css({ display: "block" }).velocity("stop", !1).velocity({ translateY: "-100%" }, { duration: 300, queue: !1, easing: "easeInOutQuad" }));
            }
        });
    });
}(jQuery), function (a) {
    var b = { data: [], placeholder: "", secondaryPlaceholder: "", autocompleteOptions: {} };a(document).ready(function () {
        ...
        var d = this;if (this.$el = a(this), this.$document = a(document), this.SELS = { CHIPS: ".chips", CHIP: ".chip", INPUT: "input", DELETE: ".material-icons", SELECTED_CHIP: ".selected" }, "data" === c) return this.$el.data("chips");var e = a.extend({}, b, c);d.hasAutocomplete = !a.isEmptyObject(e.autocompleteOptions.data), this.init = function () {
            ...
            var b = d.SELS;d.$document.off("click.chips-focus", b.CHIPS).on("click.chips-focus", b.CHIPS, function (c) {
                ...
                if (!a(c.target).is("input, textarea")) {
                    var e,
                        ...
                        if ((e = f.index() - 1) < 0) return;a(b.CHIP).removeClass("selected"), d.selectChip(e, g);
                    } else if (39 === c.which) {
                ...
                var d = a(c.target).closest(b.CHIPS);d.removeClass("focus"), void 0 !== d.data("chips") && d.data("chips").length || d.siblings("label").removeClass("active"), d.siblings(".prefix").removeClass("active");
            ...
            }), b.append(a('<input id="' + c + '" class="input" placeholder="">')), d.setPlaceholder(b);var f = b.next("label");f.length && (f.attr("for", c), void 0 !== b.data("chips") && b.data("chips").length && f.addClass("active"));var g = a("#" + c);d.hasAutocomplete && (e.autocompleteOptions.onAutocomplete = function (a) {
                d.addChip({ tag: a }, b), g.val(""), g.focus();
            }, g.autocomplete(e.autocompleteOptions));
        }, this.renderChip = function (b) {
            if (b.tag) {
                var c = a('<div class="chip"></div>');return c.text(b.tag), b.image && c.prepend(a("<img />").attr("src", b.image)), c.append(a('<i class="material-icons close">close</i>')), c;
            }
    ...
    a(document).ready(function () {
        ...
        var c = _b2;if (!1 === c.hasClass("active")) {
            var d,
                e,
                f = c.hasClass("horizontal");!0 === f ? e = 40 : d = 40, c.addClass("active"), c.find("ul .btn-floating").velocity({ scaleY: ".4", scaleX: ".4", translateY: d + "px", translateX: e + "px" }, { duration: 0 });var g = 0;c.find("ul .btn-floating").reverse().each(function () {
        ...
        var b,
            c,
            d = a,
            e = d.hasClass("horizontal");!0 === e ? c = 40 : b = 40, d.removeClass("active");d.find("ul .btn-floating").velocity("stop", !0), d.find("ul .btn-floating").velocity({ opacity: "0", scaleX: ".4", scaleY: ".4", translateY: b + "px", translateX: c + "px" }, { duration: 80 });
    },
        d = function d(b) {
        ...
        if ("true" === a.attr("data-open")) {
            var b,
                ...
                l = i.css("background-color");b = h - d / 2 + f / 2, c = e - g, d / k.width(), a.removeClass("active"), a.attr("data-open", !1), a.css({ "background-color": "transparent", transition: "none" }), i.css({ transition: "none" }), k.css({ transform: "scale(0)", "background-color": l }), j.find("> li > a").css({ opacity: "" }), setTimeout(function () {
                k.remove(), a.css({ "text-align": "", width: "", bottom: "", left: "", overflow: "", "background-color": "", transform: "translate3d(" + -b + "px,0,0)" }), i.css({ overflow: "", transform: "translate3d(0," + c + "px,0)" }), setTimeout(function () {
                    a.css({ transform: "translate3d(0,0,0)", transition: "transform .2s" }), i.css({ transform: "translate3d(0,0,0)", transition: "transform .2s cubic-bezier(0.550, 0.055, 0.675, 0.190)" });
                }, 20);
            }, 200);
        }
    };
    ...
    Materialize.fadeInImage = function (b) {
        ...
        var b = !1,
            ...
            a(this).hammer({ prevent_default: !1 }).on("pan", function (d) {
    ...
    function b(f, g, i, l) {
        function m() {
            ...
            var b;!0 === u.hiddenName ? (b = f.name, f.name = "") : (b = ["string" == typeof u.hiddenPrefix ? u.hiddenPrefix : "", "string" == typeof u.hiddenSuffix ? u.hiddenSuffix : "_submit"], b = b[0] + f.name + b[1]), y._hidden = a('<input type=hidden name="' + b + '"' + (w.data("value") || f.value ? ' value="' + y.get("select", u.formatSubmit) + '"' : "") + ">")[0], w.on("change." + t.id, function () {
                y._hidden.value = f.value ? y.get("select", u.formatSubmit) : "";
            }), u.container ? a(u.container).append(y._hidden) : w.after(y._hidden);
        }function q(a) {
            var b = a.keyCode,
                c = /^(8|46)$/.test(b);if (27 == b) return y.close(), !1;(32 == b || c || !t.open && y.component.key[b]) && (a.preventDefault(), a.stopPropagation(), c ? y.clear().close() : y.open());
        }function r(a) {
            ...
            y = x.prototype = { constructor: x, $node: w, start: function start() {
                ...
                var a,
                    ...
                    (b = c[a]) in t.methods && delete t.methods[b];
                }return y;
        ...
        var b;return a.currentStyle ? b = a.currentStyle.position : window.getComputedStyle && (b = getComputedStyle(a).position), "fixed" == b;
    }function d() {
    ...
    function c(a, b) {
    ...
    }var _d = a._;c.prototype.set = function (a, b, c) {
        var d = this,
        ...
        var f,
            g = this;return c = void 0 === c ? a : c, c == -1 / 0 || c == 1 / 0 ? f = c : b.isPlainObject(c) && _d.isInteger(c.pick) ? c = c.obj : b.isArray(c) ? (c = new Date(c[0], c[1], c[2]), c = _d.isDate(c) ? c : g.create().obj) : c = _d.isInteger(c) || _d.isDate(c) ? g.normalize(new Date(c), e) : g.now(a, c, e), { year: f || c.getFullYear(), month: f || c.getMonth(), date: f || c.getDate(), day: f || c.getDay(), obj: f || c, pick: f || c.getTime() };
    }, c.prototype.createRange = function (a, c) {
        var e = this,
            f = function f(a) {
            return !0 === a || b.isArray(a) || _d.isDate(a) ? e.create(a) : a;
        };return _d.isInteger(a) || (a = f(a)), _d.isInteger(c) || (c = f(c)), _d.isInteger(a) && b.isPlainObject(c) ? a = [c.year, c.month, c.date + a] : _d.isInteger(c) && b.isPlainObject(a) && (c = [a.year, a.month, a.date + c]), { from: f(a), to: f(c) };
        ...
        var c = this;return b ? "string" == typeof b ? b = c.parse(a, b) : _d.isInteger(b) && (b = c.now(a, b, { rel: b })) : b = "min" == a ? -1 / 0 : 1 / 0, b;
        ...
        var f,
            ...
            if (b.isArray(a)) {
                var e = j.create(a).pick;e < c.pick ? f = !0 : e > c.pick && (g = !0);
            }return _d.isInteger(a);
        }).length;if ((!e || !e.nav) && (!m && j.disabled(c) || m && j.disabled(c) && (p || f || g) || !m && (c.pick <= n.pick || c.pick >= o.pick))) for (m && !p && (!g && l > 0 || !f && l < 0) && (l *= -1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k, l = l > 0 ? 1 : -1), c.pick <= n.pick ? (h = !0, l = 1, c = j.create([n.year, n.month, n.date + (c.pick === n.pick ? 0 : -1)])) : c.pick >= o.pick && (i = !0, l = -1, c = j.create([o.year, o.month, o.date + (c.pick === o.pick ? 0 : 1)])), !h || !i);) {
            c = j.create([c.year, c.month, c.date + l]);
        }return c;
    }, c.prototype.disabled = function (a) {
        var c = this,
            e = c.item.disable.filter(function (e) {
            return _d.isInteger(e) ? a.day === (c.settings.firstDay ? e : e - 1) % 7 : b.isArray(e) || _d.isDate(e) ? a.pick === c.create(e).pick : b.isPlainObject(e) ? c.withinRange(e, a) : void 0;
        ...
        var e = this,
            f = {};return b && "string" == typeof b ? (c && c.format || (c = c || {}, c.format = e.settings.format), e.formats.toArray(c.format).map(function (a) {
            var c = e.formats[a],
                g = c ? _d.trigger(c, e, [b, f]) : a.replace(/^!/, "").length;c && (f[a] = b.substr(0, g)), b = b.substr(g);
        ...
        function a(a, b, c) {
            ...
            return a.match(/\w+/)[0].length;
                ...
                return a ? _d.digits(a) : b.date;
            }, dd: function dd(a, b) {
                return a ? 2 : _d.lead(b.date);
            }, ddd: function ddd(a, c) {
                return a ? b(a) : this.settings.weekdaysShort[c.day];
            }, dddd: function dddd(a, c) {
                return a ? b(a) : this.settings.weekdaysFull[c.day];
            }, m: function m(a, b) {
                return a ? _d.digits(a) : b.month + 1;
            }, mm: function mm(a, b) {
                return a ? 2 : _d.lead(b.month + 1);
                ...
                var c = this;return c.formats.toArray(a).map(function (a) {
                    return _d.trigger(c.formats[a], c, [0, b]) || a.replace(/^!/, "");
                }).join("");
            } };
    }(), c.prototype.isDateExact = function (a, c) {
        var e = this;return _d.isInteger(a) && _d.isInteger(c) || "boolean" == typeof a && "boolean" == typeof c ? a === c : (_d.isDate(a) || b.isArray(a)) && (_d.isDate(c) || b.isArray(c)) ? e.create(a).pick === e.create(c).pick : !(!b.isPlainObject(a) || !b.isPlainObject(c)) && e.isDateExact(a.from, c.from) && e.isDateExact(a.to, c.to);
    }, c.prototype.isDateOverlap = function (a, c) {
        var e = this,
            f = e.settings.firstDay ? 1 : 0;return _d.isInteger(a) && (_d.isDate(c) || b.isArray(c)) ? (a = a % 7 + f) === e.create(c).day + 1 : _d.isInteger(c) && (_d.isDate(a) || b.isArray(a)) ? (c = c % 7 + f) === e.create(a).day + 1 : !(!b.isPlainObject(a) || !b.isPlainObject(c)) && e.overlapRanges(a, c);
    }, c.prototype.flipEnable = function (a) {
        var b = this.item;b.enable = a || (-1 == b.enable ? 1 : -1);
    }, c.prototype.deactivate = function (a, c) {
        var e = this,
            f = e.item.disable.slice(0);return "flip" == c ? e.flipEnable() : !1 === c ? (e.flipEnable(1), f = []) : !0 === c ? (e.flipEnable(-1), f = []) : c.map(function (a) {
            for (var c, g = 0; g < f.length; g += 1) {
                if (e.isDateExact(a, f[g])) {
                    c = !0;break;
                }
            }c || (_d.isInteger(a) || _d.isDate(a) || b.isArray(a) || b.isPlainObject(a) && a.from && a.to) && f.push(a);
        }), f;
    }, c.prototype.activate = function (a, c) {
        var e = this,
            f = e.item.disable,
            g = f.length;return "flip" == c ? e.flipEnable() : !0 === c ? (e.flipEnable(1), f = []) : !1 === c ? (e.flipEnable(-1), f = []) : c.map(function (a) {
            var c, h, i, j;for (i = 0; i < g; i += 1) {
                if (h = f[i], e.isDateExact(h, a)) {
                    c = f[i] = null, j = !0;break;
                }if (e.isDateOverlap(h, a)) {
                    b.isPlainObject(a) ? (a.inverted = !0, c = a) : b.isArray(a) ? (c = a, c[3] || c.push("inverted")) : _d.isDate(a) && (c = [a.getFullYear(), a.getMonth(), a.getDate(), "inverted"]);break;
                }
        ...
        var b = this,
            ...
            l = e.max,
            m = function (a, b) {
            return c.firstDay && (a.push(a.shift()), b.push(b.shift())), _d.node("thead", _d.node("tr", _d.group({ min: 0, max: 6, i: 1, node: "th", item: function item(d) {
                    return [a[d], c.klass.weekdays, 'scope=col title="' + b[d] + '"'];
                } })));
        }((c.showWeekdaysFull ? c.weekdaysFull : c.weekdaysLetter).slice(0), c.weekdaysFull.slice(0)),
            n = function n(a) {
            return _d.node("div", " ", c.klass["nav" + (a ? "Next" : "Prev")] + (a && i.year >= l.year && i.month >= l.month || !a && i.year <= k.year && i.month <= k.month ? " " + c.klass.navDisabled : ""), "data-nav=" + (a || -1) + " " + _d.ariaAttr({ role: "button", controls: b.$node[0].id + "_table" }) + ' title="' + (a ? c.labelMonthNext : c.labelMonthPrev) + '"');
        },
            o = function o(e) {
            var f = c.showMonthsShort ? c.monthsShort : c.monthsFull;return "short_months" == e && (f = c.monthsShort), c.selectMonths && void 0 == e ? _d.node("select", _d.group({ min: 0, max: 11, i: 1, node: "option", item: function item(a) {
                    return [f[a], 0, "value=" + a + (i.month == a ? " selected" : "") + (i.year == k.year && a < k.month || i.year == l.year && a > l.month ? " disabled" : "")];
                } }), c.klass.selectMonth + " browser-default", (a ? "" : "disabled") + " " + _d.ariaAttr({ controls: b.$node[0].id + "_table" }) + ' title="' + c.labelMonthSelect + '"') : "short_months" == e ? null != g ? f[g.month] : f[i.month] : _d.node("div", f[i.month], c.klass.month);
        },
            p = function p(e) {
            var f = i.year,
                g = !0 === c.selectYears ? 5 : ~~(c.selectYears / 2);if (g) {
                var h = k.year,
                    j = l.year,
                    m = f - g,
                    n = f + g;if (h > m && (n += h - m, m = h), j < n) {
                    var o = m - h,
                        p = n - j;m -= o > p ? p : o, n = j;
                }if (c.selectYears && void 0 == e) return _d.node("select", _d.group({ min: m, max: n, i: 1, node: "option", item: function item(a) {
                        return [a, 0, "value=" + a + (f == a ? " selected" : "")];
                    } }), c.klass.selectYear + " browser-default", (a ? "" : "disabled") + " " + _d.ariaAttr({ controls: b.$node[0].id + "_table" }) + ' title="' + c.labelYearSelect + '"');
            }return "raw" == e ? _d.node("div", f) : _d.node("div", f, c.klass.year);
        };return createDayLabel = function createDayLabel() {
            return null != g ? g.date : f.date;
        }, createWeekdayLabel = function createWeekdayLabel() {
            var a;return a = null != g ? g.day : f.day, c.weekdaysShort[a];
        }, _d.node("div", _d.node("div", p("raw"), c.klass.year_display) + _d.node("span", createWeekdayLabel() + ", ", "picker__weekday-display") + _d.node("span", o("short_months") + " ", c.klass.month_display) + _d.node("span", createDayLabel(), c.klass.day_display), c.klass.date_display) + _d.node("div", _d.node("div", _d.node("div", (c.selectYears, o() + p() + n() + n(1)), c.klass.header) + _d.node("table", m + _d.node("tbody", _d.group({ min: 0, max: 5, i: 1, node: "tr", item: function item(a) {
                var e = c.firstDay && 0 === b.create([i.year, i.month, 1]).day ? -7 : 0;return [_d.group({ min: 7 * a - i.day + e + 1, max: function max() {
                        return this.min + 7 - 1;
                    }, i: 1, node: "td", item: function item(a) {
                        a = b.create([i.year, i.month, a + (c.firstDay ? 1 : 0)]);var e = g && g.pick == a.pick,
                            m = h && h.pick == a.pick,
                            n = j && b.disabled(a) || a.pick < k.pick || a.pick > l.pick,
                            o = _d.trigger(b.formats.toString, b, [c.format, a]);return [_d.node("div", a.date, function (b) {
                        ...
                        }([c.klass.day]), "data-pick=" + a.pick + " " + _d.ariaAttr({ role: "gridcell", label: o, selected: !(!e || b.$node.val() !== o) || null, activedescendant: !!m || null, disabled: !!n || null })), "", _d.ariaAttr({ role: "presentation" })];
                    } })];
            } })), c.klass.table, 'id="' + b.$node[0].id + '_table" ' + _d.ariaAttr({ role: "grid", controls: b.$node[0].id, readonly: !0 })), c.klass.calendar_container) + _d.node("div", _d.node("button", c.today, "btn-flat picker__today waves-effect", "type=button data-pick=" + f.pick + (a && !b.disabled(f) ? "" : " disabled") + " " + _d.ariaAttr({ controls: b.$node[0].id })) + _d.node("button", c.clear, "btn-flat picker__clear waves-effect", "type=button data-clear=1" + (a ? "" : " disabled") + " " + _d.ariaAttr({ controls: b.$node[0].id })) + _d.node("button", c.close, "btn-flat picker__close waves-effect", "type=button data-close=true " + (a ? "" : " disabled") + " " + _d.ariaAttr({ controls: b.$node[0].id })), c.klass.footer), "picker__container__wrapper");
    ...
    function a(a) {
        ...
        function i(a, b) {
            var c = l.offset(),
                ...
                k = Math.sqrt(i * i + j * j),
                m = !1;if (!b || !(k < s - u || k > s + u)) {
                a.preventDefault();var p = setTimeout(function () {
                    D.popover.addClass("clockpicker-moving");
                }, 200);D.setHand(i, j, !b, !0), h.off(n).on(n, function (a) {
                    a.preventDefault();var b = /^touch/.test(a.type),
                        c = (b ? a.originalEvent.touches[0] : a).pageX - e,
                        d = (b ? a.originalEvent.touches[0] : a).pageY - f;(m || c !== i || d !== j) && (m = !0, D.setHand(c, d, !1, !0));
                }), h.off(o).on(o, function (a) {
                    h.off(o), a.preventDefault();var c = /^touch/.test(a.type),
                        d = (c ? a.originalEvent.changedTouches[0] : a).pageX - e,
                        k = (c ? a.originalEvent.changedTouches[0] : a).pageY - f;(b || m) && d === i && k === j && D.setHand(d, k), "hours" === D.currentView ? D.toggleView("minutes", w / 2) : g.autoclose && (D.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                        D.done();
        ...
        var a,
            b = document.createElement("div");return b.innerHTML = "<svg/>", a = (b.firstChild && b.firstChild.namespaceURI) == i, b.innerHTML = "", a;
    }(),
        k = function () {
        var a = document.createElement("div").style;return "transition" in a || "WebkitTransition" in a || "MozTransition" in a || "msTransition" in a || "OTransition" in a;
    }(),
        ...
        if (!this.isShown) {
            e(this.options.beforeShow), f(":input").each(function () {
                ...
                var b = f(a.target);0 === b.closest(c.popover.find(".picker__wrap")).length && 0 === b.closest(c.input).length && c.hide();
        ...
        var c = !1;"minutes" === a && "visible" === f(this.hoursView).css("visibility") && (e(this.options.beforeHourSelect), c = !0);var d = "hours" === a,
            g = d ? this.hoursView : this.minutesView,
            h = d ? this.minutesView : this.hoursView;this.currentView = a, this.spanHours.toggleClass("text-primary", d), this.spanMinutes.toggleClass("text-primary", !d), h.addClass("clockpicker-dial-out"), g.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(b), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function () {
        ...
        var b = this.currentView,
            ...
            h = Math.sin(f) * g,
            i = -Math.cos(f) * g,
            k = this;j && a ? (k.canvas.addClass("clockpicker-canvas-out"), setTimeout(function () {
        ...
        var g,
            ...
            m = this.options,
            n = i && l < (s + t) / 2,
            o = n ? t : s;if (m.twelvehour && (o = s), h < 0 && (h = 2 * Math.PI + h), g = Math.round(h / k), h = g * k, m.twelvehour ? i ? 0 === g && (g = 12) : (d && (g *= 5), 60 === g && (g = 0)) : i ? (12 === g && (g = 0), g = n ? 0 === g ? 12 : g : 0 === g ? 0 : g + 12) : (d && (g *= 5), 60 === g && (g = 0)), this[this.currentView] !== g && p && this.options.vibrate && (this.vibrateTimer || (navigator[p](10), this.vibrateTimer = setTimeout(f.proxy(function () {
            ...
            var a = f(this);a.toggleClass("active", g === +a.html());
        });var q = Math.sin(h) * (o - u),
            r = -Math.cos(h) * (o - u),
            v = Math.sin(h) * o,
            w = -Math.cos(h) * o;this.hand.setAttribute("x2", q), this.hand.setAttribute("y2", r), this.bg.setAttribute("cx", v), this.bg.setAttribute("cy", w);
    }, d.prototype.done = function () {
        e(this.options.beforeDone), this.hide(), this.label.addClass("active");var a = this.input.prop("value"),
            c = b(this.hours) + ":" + b(this.minutes);this.options.twelvehour && (c += this.amOrPm), this.input.prop("value", c), c !== a && (this.input.triggerHandler("change"), this.isInput || this.element.trigger("change")), this.options.autoclose && this.input.trigger("blur"), e(this.options.afterDone);
    }, d.prototype.clear = function () {
        this.hide(), this.label.removeClass("active");var a = this.input.prop("value");this.input.prop("value", ""), "" !== a && (this.input.triggerHandler("change"), this.isInput || this.element.trigger("change")), this.options.autoclose && this.input.trigger("blur");
        ...
        var b = Array.prototype.slice.call(arguments, 1);return this.each(function () {
            var c = f(this),
                e = c.data("clockpicker");if (e) "function" == typeof e[a] && e[a].apply(e, b);else {
                var g = f.extend({}, d.DEFAULTS, c.data(), "object" == (typeof a === 'undefined' ? 'undefined' : _typeof(a)) && a);c.data("clockpicker", new d(c, g));
            }
        });
    };
}(), function (a) {
    function b() {
        ...
        return this.each(function () {
            var e = a(this);e.parent().find('span[class="character-counter"]').length || void 0 !== e.attr("data-length") && (e.on("input", b), e.on("focus", b), e.on("blur", d), c(e));
        });
    }, a(document).ready(function () {
    ...
    var b = { init: function init(b) {
            var c = { duration: 200, dist: -100, shift: 0, padding: 0, fullWidth: !1, indicators: !1, noWrap: !1, onCycleTo: null };b = a.extend(c, b);var d = Materialize.objectSelectorString(a(this));return this.each(function (c) {
                function e(a) {
                    ...
                    D = !0, O.hasClass("scrolling") || O.addClass("scrolling"), null != M && window.clearTimeout(M), M = window.setTimeout(function () {
                        ...
                        j,
                        k,
                        l = t;if (s = "number" == typeof c ? c : s, t = Math.floor((s + v / 2) / v), f = s - t * v, h = f < 0 ? 1 : -1, i = -h * f * 2 / v, e = w >> 1, b.fullWidth ? k = "translateX(0)" : (k = "translateX(" + (O[0].clientWidth - q) / 2 + "px) ", k += "translateY(" + (O[0].clientHeight - r) / 2 + "px)"), P) {
                        var m = t % w,
                            n = L.find(".indicator-item.active");n.index() !== m && (n.removeClass("active"), L.find(".indicator-item").eq(m).addClass("active"));
                        ...
                        var o = O.find(".carousel-item").eq(g(t));b.onCycleTo.call(this, o, I);
                    }"function" == typeof N && (N.call(this, o, I), N = null);
                }function i() {
                    var a, b, c, d;a = Date.now(), b = a - G, G = a, c = s - F, F = s, d = 1e3 * c / (1 + b), C = .8 * d + .2 * C;
                }function j() {
                    var a, c;A && (a = Date.now() - G, c = A * Math.exp(-a / b.duration), c > 2 || c < -2 ? (h(B - c), requestAnimationFrame(j)) : h(B));
                }function k(c) {
                    if (I) return c.preventDefault(), c.stopPropagation(), !1;if (!b.fullWidth) {
                        var d = a(c.target).closest(".carousel-item").index();0 !== g(t) - d && (c.preventDefault(), c.stopPropagation()), l(d);
                    }
                }function l(a) {
                    var c = t % w - a;b.noWrap || (c < 0 ? Math.abs(c + w) < Math.abs(c) && (c += w) : c > 0 && Math.abs(c - w) < c && (c -= w)), c < 0 ? O.trigger("carouselNext", [Math.abs(c)]) : c > 0 && O.trigger("carouselPrev", [c]);
                }function m(a) {
                    "mousedown" === a.type && a.preventDefault(), u = !0, I = !1, J = !1, x = e(a), z = f(a), C = A = 0, F = s, G = Date.now(), clearInterval(H), H = setInterval(i, 100);
                }function n(a) {
                    var b, c;if (u) if (b = e(a), y = f(a), c = x - b, Math.abs(z - y) < 30 && !J) (c > 2 || c < -2) && (I = !0, x = b, h(s + c));else {
                        if (I) return a.preventDefault(), a.stopPropagation(), !1;J = !0;
                    ...
                    N = null,
                    O = a(this),
                    P = O.attr("data-indicators") || b.indicators;if (b.fullWidth && (b.dist = 0, function () {
                ...
                }(), P && O.find(".carousel-fixed-item").addClass("with-indicators")), O.hasClass("initialized")) return a(window).trigger("resize"), a(this).trigger("carouselNext", [1e-6]), !0;O.addClass("initialized"), u = !1, s = B = 0, p = [], q = O.find(".carousel-item").first().innerWidth(), r = O.find(".carousel-item").first().innerHeight(), v = 2 * q + b.padding, O.find(".carousel-item").each(function (b) {
                    ...
                    var b = a + "Transform";return void 0 === document.body.style[b] || (E = b, !1);
                }), a(window).off("resize.carousel-" + K).on("resize.carousel-" + K, function () {
                    b.fullWidth ? (q = O.find(".carousel-item").first().innerWidth(), r = O.find(".carousel-item").first().innerHeight(), v = 2 * q + b.padding, s = 2 * t * q, B = s) : h();
                }), function () {
                ...
                }(), h(s), a(this).on("carouselNext", function (a, b, c) {
        ...
        }, next: function next(b, c) {
            a(this).trigger("carouselNext", [b, c]);
        }, prev: function prev(b, c) {
    ...
    var b = { init: function init(b) {
            return this.each(function () {
                var c = a("#" + a(this).attr("data-activates")),
                    ...
                    var b = "fixed" === c.css("position");if (!b) for (var g = c.parents(), i = 0; i < g.length && !(b = "fixed" == a(g[i]).css("position")); i++) {}var j = c.outerWidth(),
                        ...
                        J = x / 2 - I / 2,
                        K = w / 2 - H / 2,
                        L = {};L.top = t ? y : "", L.right = s ? n - z - w : "", L.bottom = u ? o - y - x : "", L.left = r ? z : "", L.position = A, e.css(L), h.css({ width: B, height: C, top: D, right: 0, bottom: 0, left: E, padding: F, verticalAlign: G }), f.css({ top: J, left: K, width: H, height: I });
                };"open" == b && (j(), function () {
        ...
        if (b[c] || "object" == (typeof c === 'undefined' ? 'undefined' : _typeof(c))) return b.init.apply(this, arguments);a.error("Method " + c + " does not exist on jQuery.tap-target");
    };
}(jQuery);